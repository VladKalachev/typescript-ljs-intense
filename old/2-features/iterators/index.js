...
function getItemsReallySlowly(items) {
    return __asyncGenerator(this, arguments, function getItemsReallySlowly_1() {
        var _i, items_1, item;
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    _b = __asyncValues(getItemsReallySlowly(items));
                    _d.label = 1;
...
exports.speakLikeSloth = speakLikeSloth;
